...
export const GITHUB_WORKFLOW_SCHEMA: Readonly<Record<string, unknown>> = {
  ...
  definitions: {
    ...
    jobContainer: {
      ...
      properties: {
        image: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idcontainerimage',
          description:
        ...
        credentials: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idcontainercredentials',
          description:
        ...
        env: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idcontainerenv',
          $ref: '#/definitions/env',
          description: 'Sets a map of environment variables in the container.',
        },
        ports: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idcontainerports',
        ...
        volumes: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idcontainervolumes',
          description:
        ...
        options: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idcontaineroptions',
          description:
    ...
    serviceContainer: {
      ...
      properties: {
        image: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idservicesservice_idimage',
          description:
        ...
        credentials: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idservicesservice_idcredentials',
          description:
            "If the image's container registry requires authentication to pull the image, you can use credentials to set a map of the username and password. The credentials are the same values that you would provide to the `docker login` command.",
          type: 'object',
          properties: {
        ...
        env: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idservicesservice_idenv',
          $ref: '#/definitions/env',
          description: 'Sets a map of environment variables in the service container.',
        },
        ports: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idservicesservice_idports',
        ...
        volumes: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idservicesservice_idvolumes',
          description:
        ...
        options: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idservicesservice_idoptions',
          description:
            'Additional Docker container resource options. For a list of options, see https://docs.docker.com/engine/reference/commandline/create/#options.',
          type: 'string',
        },
        command: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idservicesservice_idcommand',
          description:
        ...
        entrypoint: {
          $comment:
            'https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#jobsjob_idservicesservice_identrypoint',
          description:
    ...
    snapshot: {
      ...
      oneOf: [
        {
          $comment:
            'https://docs.github.com/en/actions/how-tos/manage-runners/larger-runners/use-custom-images#string-syntax',
          type: 'string',
          description:
        ...
        {
          $comment:
            'https://docs.github.com/en/actions/how-tos/manage-runners/larger-runners/use-custom-images#mapping-syntax',
          type: 'object',
          additionalProperties: false,
          description:
          ...
          properties: {
            ...
            version: {
              $comment:
                'https://docs.github.com/en/actions/how-tos/manage-runners/larger-runners/use-custom-images#specifying-a-version-in-your-workflow',
              type: 'string',
              pattern: '^\\d+(\\.\\d+|\\*)?$',
            },
          },
    ...
    step: {
      ...
      properties: {
        ...
        background: {
          $comment:
            'https://docs.github.com/en/actions/writing-workflows/workflow-syntax-for-github-actions#jobsjob_idstepsbackground',
          description:
        ...
        wait: {
          $comment:
            'https://docs.github.com/en/actions/writing-workflows/workflow-syntax-for-github-actions#jobsjob_idstepswait',
          description:
        ...
        'wait-all': {
          $comment:
            'https://docs.github.com/en/actions/writing-workflows/workflow-syntax-for-github-actions#jobsjob_idstepswait-all',
          description:
        ...
        cancel: {
          $comment:
            'https://docs.github.com/en/actions/writing-workflows/workflow-syntax-for-github-actions#jobsjob_idstepscancel',
          description:
        ...
        parallel: {
          $comment:
            'https://docs.github.com/en/actions/writing-workflows/workflow-syntax-for-github-actions#jobsjob_idstepsparallel',
          description:
      ...
      oneOf: [
        ...
        },
        {
          ...
          properties: {
            ...
            options: {
              $ref: '#/definitions/workflowDispatchInput/properties/options',
            },
          },
              ...
              oneOf: [
                ...
                },
                {
                  ...
                  properties: {
                    ...
                    outputs: {
                      $comment:
                        'https://docs.github.com/en/actions/reference/workflow-syntax-for-github-actions#onworkflow_calloutputs',
                      description:
                        'When using the workflow_call keyword, you can optionally specify inputs that are passed to the called workflow from the caller workflow.',
                      type: 'object',
                      patternProperties: {
                        '^[_a-zA-Z][a-zA-Z0-9_-]*$': {
                          $comment:
                            'https://docs.github.com/en/actions/sharing-automations/creating-actions/metadata-syntax-for-github-actions#outputsoutput_id',
                          description:
                          ...
                          properties: {
                            description: {
                              $comment:
                                'https://docs.github.com/en/actions/sharing-automations/creating-actions/metadata-syntax-for-github-actions#outputsoutput_iddescription',
                              description: 'A string description of the output parameter.',
                              type: 'string',
                            },
                            value: {
                              $comment:
                                'https://docs.github.com/en/actions/sharing-automations/creating-actions/metadata-syntax-for-github-actions#outputsoutput_idvalue',
                              description:
