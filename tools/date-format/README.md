...
Preview strftime, Unicode LDML and Intl date patterns side by side.
...
```sh
npx degit JoshKCIT/free-open-dev-tools/tools/date-format date-format
cd date-format
npm install
npm test
```
