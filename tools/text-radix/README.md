...
- This tool always reads its input as text characters, never as a numeric value. There is no mode, option or heuristic anywhere in it that reads a number out of the input instead.
